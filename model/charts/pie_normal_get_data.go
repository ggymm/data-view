...
var PieNormalGetDataHandle = &ChartDataHandler{RunGetDataFromDB: func(db *sql.DB, chartDataParams *schema.ChartDataParams) (string, error) {
...
func PieNormalFormatRows(rows *sql.Rows, chartDataParams *schema.ChartDataParams) (*[]interface{}, error) {
	// 普通饼图==环形饼图==2D饼图==词云
