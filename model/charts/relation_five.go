...
var RelationFiveGetDataHandle = &ChartDataHandler{RunGetDataFromDB: func(db *sql.DB, chartDataParams *schema.ChartDataParams) (string, error) {
	...
	dataResults, err := RelationFiveFormatRows(rows, chartDataParams)
	if err != nil {
		return EmptyString, err
	}
...
func RelationFiveFormatRows(rows *sql.Rows, chartDataParams *schema.ChartDataParams) (*map[string]interface{}, error) {
