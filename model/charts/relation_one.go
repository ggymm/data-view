...
var RelationOneGetDataHandle = &ChartDataHandler{RunGetDataFromDB: func(db *sql.DB, chartDataParams *schema.ChartDataParams) (string, error) {
	...
	dataResults, err := RelationOneFormatRows(rows, chartDataParams)
	if err != nil {
		return EmptyString, err
	}
...
func RelationOneFormatRows(rows *sql.Rows, chartDataParams *schema.ChartDataParams) (*map[string]interface{}, error) {
