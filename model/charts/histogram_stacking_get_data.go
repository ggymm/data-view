...
var HistogramStackingGetDataHandle = &ChartDataHandler{RunGetDataFromDB: func(db *sql.DB, chartDataParams *schema.ChartDataParams) (string, error) {
	...
	dataResults, err := HistogramStackingFormatRows(rows, chartDataParams)
	if err != nil {
		return EmptyString, err
	}
...
func HistogramStackingFormatRows(rows *sql.Rows, chartDataParams *schema.ChartDataParams) (*[]interface{}, error) {
