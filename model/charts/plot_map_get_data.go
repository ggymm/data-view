...
var PlotMapGetDataHandle = &ChartDataHandler{RunGetDataFromDB: func(db *sql.DB, chartDataParams *schema.ChartDataParams) (string, error) {
...
func PlotMaplFormatRows(rows *sql.Rows, chartDataParams *schema.ChartDataParams) (*[]map[string]interface{}, error) {
